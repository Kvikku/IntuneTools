...
namespace IntuneTools.Graph.IntuneHelperClasses
{
    public class SettingsCatalogHelper
    {
        ...
        //public static void AddSettingsCatalogToDTG(List<DeviceManagementConfigurationPolicy> policies)
        //{
        //    try
        //    {
        //        if (policies == null)
        ...
        //        LogToImportStatusFile("Adding settings catalog policies to the DataGridView.");
